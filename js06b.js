...
subButton.addEventListener("click", validateCredit)
...
function validateName() {
   ...
   if (cardName.validity.valueMissing) {
      cardName.setCustomVisibility("Enter your name as it appears on the card")
   } else {
      cardName.setCustomVisibility("")
   }
}
...
function validateMonth() {
   ...
   if (month.selectedIndex === 0) {
      month.setCustomVisibility("Select the expiration month")
   } else {
...
function validateYear() {
   ...
   if (year.selectedIndex === 0) {
      year.setCustomVisibility("Select the expiration year")
   } else {
